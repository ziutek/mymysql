...
### func (*Statement) [SendLongData][62]
...
pnum - Parameter number to associate the data with. data - Data source string,
[]byte or io.Reader. pkt_size - It must be must be greater than 6 and less or
equal to MySQL
...
### func [TimeToTimestamp][64]

`func TimeToTimestamp(tt *time.Time) *Timestamp`

### func (*Timestamp) [String][65]
...
[godoc][71]
   ...
   [28]: /mymysql/common.go#L91

   [29]: /mymysql/binding.go#L21

   [30]: /mymysql/errors.go#L34

   [31]: /mymysql/errors.go#L39

   [32]: /mymysql/result.go#L12

   [33]: /mymysql/mysql.go#L23

   [34]: /mymysql/mysql.go#L54

   [35]: /mymysql/mysql.go#L117

   [36]: /mymysql/mysql.go#L94

   [37]: /mymysql/mysql.go#L293

   [38]: /mymysql/mysql.go#L334

   [39]: /mymysql/mysql.go#L273

   [40]: /mymysql/mysql.go#L132

   [41]: /mymysql/mysql.go#L199

   [42]: /mymysql/mysql.go#L167

   [43]: /mymysql/binding.go#L48

   [44]: /mymysql/result.go#L26

   [45]: /mymysql/mysql.go#L264

   [46]: /mymysql/mysql.go#L237

   [47]: /mymysql/result.go#L49

   [48]: /mymysql/result.go#L54

   [49]: /mymysql/result.go#L135

   [50]: /mymysql/result.go#L87

   [51]: /mymysql/result.go#L125

   [52]: /mymysql/result.go#L168

   [53]: /mymysql/result.go#L71

   [54]: /mymysql/result.go#L178

   [55]: /mymysql/result.go#L142

   [56]: /mymysql/mysql.go#L13

   [57]: /mymysql/prepared.go#L7

   [58]: /mymysql/mysql.go#L365

   [59]: /mymysql/mysql.go#L426

   [60]: /mymysql/mysql.go#L405

   [61]: /mymysql/mysql.go#L448

   [62]: /mymysql/mysql.go#L486

   [63]: /mymysql/binding.go#L41

   [64]: /mymysql/common.go#L102

   [65]: /mymysql/binding.go#L42

   [66]: /mymysql/binding.go#L8

   [67]: /mymysql/unsafe.go#L8
